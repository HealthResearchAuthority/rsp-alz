...
resource configStore 'Microsoft.AppConfiguration/configurationStores@2024-05-01' = {
  ...
  properties: {
    ...
    publicNetworkAccess: 'Enabled' //Keeping this enabled for now to avoid failed deployments
    dataPlaneProxy: {
...
module appConfigPrivateEndpoint '../../shared/bicep/network/private-endpoint.bicep' = if (enablePrivateEndpoints) {
  ...
  params: {
    ...
    privateDnsZonesId: enablePrivateEndpoints ? appConfigPrivateDnsZone.outputs.privateDnsZonesId : ''
    tags: tags
  }
}
