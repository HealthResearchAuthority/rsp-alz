...
module spoke 'modules/02-spoke/deploy.spoke.bicep' = [for i in range(0, length(parSpokeNetworks)): {
  ...
  params: {
    ...
    parDevBoxVNetPeering: parSpokeNetworks[i].devBoxPeering
    parDevBoxVNetPeeringSubscriptionID: parDevBoxVNetPeeringSubscriptionID
    parDevBoxVNetPeeringResourceGroup: parDevBoxVNetPeeringResourceGroup
    parDevBoxVNetPeeringVNetName: parDevBoxVNetPeeringVNetName
  }
}]
